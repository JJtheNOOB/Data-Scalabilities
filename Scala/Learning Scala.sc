object LearningScala1 {
  ...
  // Dealing with booleans, if 2 &&, it would bail if the first boolean is reconginized as false
  ...
  val pitimestwo = pi * 2                         //> pitimestwo  : Double = 6.2831853
  println(f"This is pi with 3 decimal points $pitimestwo%.3f")
                                                  //> This is pi with 3 decimal points 6.283
}
